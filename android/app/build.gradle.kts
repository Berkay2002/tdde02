...
android {
    namespace = "com.snapgredient.app"
    ...
    defaultConfig {
        ...
        applicationId = "com.snapgredient.app"
        // You can update the following values to match your application needs.
        // For more information, see: https://flutter.dev/to/review-gradle-config.
        minSdk = flutter.minSdkVersion  // Android 6.0 (Marshmallow) - Required for modern Firebase and camera APIs
